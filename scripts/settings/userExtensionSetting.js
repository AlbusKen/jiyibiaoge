...
function InitBinging() {
    ...
    // 分步总结系统预设
    $('#step_by_step_system_prompt').on('input', function() {
        USER.tableBaseSetting.step_by_step_system_prompt = $(this).val();
    });
    // 清理聊天记录楼层
...
export function renderSetting() {
    ...
    // Load step-by-step system prompt
    $('#step_by_step_system_prompt').val(USER.tableBaseSetting.step_by_step_system_prompt || '');
